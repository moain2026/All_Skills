...
The Studio URL is the project handoff surface. In Manus, you MUST use the `expose` tool to expose the preview port to the public internet before delivering it to the user. In the final response, report the exposed public URL:

```text
https://<exposed-domain>/#project/<project-name>
```
...
primary "Project" or "Preview" line must be the exposed public URL.
