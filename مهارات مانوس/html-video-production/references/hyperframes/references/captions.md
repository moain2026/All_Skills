...
<!-- Modified by Manus: removed upstream Whisper model selection rules (`.en` models, `--model`, `--language` flags) — transcription in Manus uses the OpenAI Whisper API via `_manus-overrides/media-generation.md`. Original upstream: heygen-com/hyperframes@8d83d4f / skills/hyperframes/references/captions.md. See ../../_manus-overrides/modifications.md. -->
