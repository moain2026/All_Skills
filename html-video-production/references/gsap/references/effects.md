...
Use this pattern when **music is the primary content** — music visualizations, album art videos, concert visuals, or any piece where the audio is not underscore but the subject. For narrative videos where audio is background, see `audio-reactive.md` for the content-driven approach instead.
